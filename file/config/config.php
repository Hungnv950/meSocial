...
$config = array(
	...
	|
	*/
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ?
			'https' : 'http') . '://' . $_SERVER['HTTP_HOST'].str_replace('/file/dialog.php','', $_SERVER['PHP_SELF']),
